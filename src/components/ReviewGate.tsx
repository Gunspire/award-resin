...
const FEEDBACK_EMAIL = "awardresinltd@gmail.com";
const PHONE_NUMBER_RAW = "08000726609";
const PHONE_NUMBER_DISPLAY = "0800 072 6609";

const DEFAULT_GOOGLE_REVIEW_URL =
  "https://www.google.com/search?q=Award%20Resin%20Ltd%20reviews";
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <div className="px-6 sm:px-10 py-10 sm:py-12">
          <div className="max-w-xl">
            <p className="text-sm font-semibold text-blue-700">Award Resin Ltd</p>
        ...
        <div className="px-6 sm:px-10 py-6 bg-slate-900 text-slate-200 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <a
            ...
            href="https://wa.me/448000726609?text=Hi%20Award%20Resin%20%E2%80%94%20I%27d%20like%20some%20help%20with%20my%20recent%20job."
            target="_blank"
            rel="noreferrer"
          >
            WhatsApp us →
