      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7">
            <SectionHeading subtitle="Why Award Resin" className="mb-8">
              Built on Trust & Quality
            </SectionHeading>

            <p className="text-slate-600 leading-relaxed text-base md:text-lg max-w-2xl">
              Premium resin bound surfacing, transparent pricing, and a team you can actually rely on. We
              treat your property like it's our own — and we back our work in writing.
            </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 shadow-lg overflow-hidden">
              <div className="aspect-[4/5] relative">
                <img
                  ...
                  alt="Award Resin Ltd team at work"
